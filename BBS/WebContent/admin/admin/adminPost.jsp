 ...
 <div style="float: right; margin-top: 10px;">
            ...
            <tbody>
              ...
              <tr class="alt-row" >         
                ...
                <td>
                  <!-- Icons -->
                  <a href="adminDeletePostAction?postId=<s:property value = "#posts.postId" /> " title="Delete"><img src="${pageContext.request.contextPath}/admin/resources/images/icons/cross.png" alt="Delete"> </td>
              </tr>
             </s:iterator >
            </tbody>
          </table>
